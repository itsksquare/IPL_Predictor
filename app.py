...
linear_regressor = pickle.load(open('Weights\\first-innings-score-lr-model-ann.pkl', 'rb'))
ridge_regressor = pickle.load(open('Weights\\first-innings-score-lr-model-ridge.pkl', 'rb'))
ann = pickle.load(open('Weights\\first-innings-score-lr-model-ann.pkl', 'rb'))
rf_regressor = pickle.load(open('Weights\\first-innings-score-lr-model-rf.pkl'
, 'rb'))
